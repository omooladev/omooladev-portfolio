...
const createThumbnail = (project: Project, singleProject: HTMLDivElement) => {
...
const createProjectDetails = (project: Project, singleProject: HTMLDivElement) => {
...
const createProjectLink = (project: Project, singleProject: HTMLDivElement) => {
